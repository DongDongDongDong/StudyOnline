...
- (instancetype)init
{
    self = [super init];
    if (self) {
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(finishTask:) name:@"NOTIFICATION_FINISH_UPLOAD_TASK" object:nil];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pauseTask:) name:@"NOTIFICATION_PAUSE_UPLOAD_TASK" object:nil];
    }
    return self;
}
